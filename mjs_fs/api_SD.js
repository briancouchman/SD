let SD = {
    ...
    _begin:         ffi('int mgos_sd_begin(void *, int pin_num_miso, int pin_num_mosi, int pin_num_clk, int pin_num_cs)'),
    _close:         ffi('void mgos_sd_close(void *)'),
    _read:          ffi('int mgos_sd_read(void *, const char *filename, int bufsize)'),
    _write:         ffi('int mgos_sd_write(void *, const char *filename, int bufsize)'),
